...
class KamarAdapter(val listKamar : ArrayList<Kamar>, val clickListener: (Kamar) -> Unit) : RecyclerView.Adapter<KamarAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.bind(listKamar[position], clickListener)
